...
namespace puck.core.Helpers
{
    public partial class ApiHelper
    {
        ...
        public ApiHelper(PuckRoleManager RoleManager, PuckUserManager UserManager, I_Puck_Repository Repo, I_Task_Dispatcher TaskDispatcher, I_Content_Indexer Indexer, I_Log Logger)
        {
